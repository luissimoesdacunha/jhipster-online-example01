...
export const DocumentDeleteDialog = (props: IDocumentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsteronlineexample01App.document.delete.question">
        <Translate contentKey="jhipsteronlineexample01App.document.delete.question" interpolate={{ id: documentEntity.id }}>
