...
export const CarDeleteDialog = (props: ICarDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsteronlineexample01App.car.delete.question">
        <Translate contentKey="jhipsteronlineexample01App.car.delete.question" interpolate={{ id: carEntity.id }}>
